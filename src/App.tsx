      ...
      <div className="bg-[#0E2A3F] min-h-screen flex flex-col items-center p-4 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4">
          <div className="flex flex-col items-center md:order-2">
            <img src={prizes[0].image} alt={prizes[0].title} className="w-96 h-96 mb-4" />
            <div className="bg-[rgba(199,_199,_199,_0.21)] border border-[#C7C7C7] p-4 rounded-3xl text-center md:w-64 sm:w-64 lg:w-96 md:h-28 sm:h-28 lg:h-36">
              <h2 className="text-2xl md:text-xl sm:text-xl text-[#EBD176] font-body [text-shadow:_0_2px_4px_rgba(255,_255,_255,_0.56)] my-1">
                {prizes[0].title}
              </h2>
          ...
          <div className="flex flex-col items-center md:order-1">
            <img src={prizes[1].image} alt={prizes[1].title} className="w-80 h-80 mb-4" />
            <div className="bg-[rgba(199,_199,_199,_0.21)] border border-[#C7C7C7] p-4 rounded-3xl text-center md:w-64 sm:w-64 lg:w-96 md:h-28 sm:h-28 lg:h-36">
              <h2 className="text-2xl md:text-xl sm:text-xl text-[#EBD176] font-body [text-shadow:_0_2px_4px_rgba(255,_255,_255,_0.56)] my-1">
                {prizes[1].title}
              </h2>
          ...
          <div className="flex flex-col items-center md:order-3">
            <img src={prizes[2].image} alt={prizes[2].title} className="w-80 h-80 mb-4" />
            <div className="bg-[rgba(199,_199,_199,_0.21)] border border-[#C7C7C7] p-4 rounded-3xl text-center md:w-64 sm:w-64 lg:w-96 md:h-28 sm:h-28 lg:h-36">
              <h2 className="text-2xl md:text-xl sm:text-xl text-[#EBD176] font-body [text-shadow:_0_2px_4px_rgba(255,_255,_255,_0.56)] my-1">
                {prizes[2].title}
              </h2>
        ...
        <div className="flex flex-col items-center mt-8">
          <div className="flex flex-row justify-center items-center bg-[rgba(199,_199,_199,_0.21)] border border-[#C7C7C7] p-4 rounded-3xl text-center lg:h-24 lg:w-[586px] md:w-64	sm:w-64	md:h-12 sm:h-12">
            <Text className="lg:text-2xl md:text-xl sm:text-xl text-[#EBD176] text-center font-body [text-shadow:_0_2px_4px_rgba(255,_255,_255,_0.56)] mr-2">

...
const classNames: ClassNames = {
  MainTopic: 'font-body text-default font-[500] font-ibm text-secondary_blue-100',
  SubTopic: ' pl-5 font-body font-ibm text-default font-normal text-text_color-100',
  SubTopicRoman: ' pl-5 font-body text-default font-normal font-ibm text-text_color-100'
}

const MathContent: React.FC = (): JSX.Element => {
  return (
    <>
      <h1 className="mb-5 text-center text-2xl font-[550] text-primary_yellow-100">หมวดคณิตศาสตร์</h1>
      <div className="custom-scroll max-h-[500px] w-auto self-stretch overflow-y-auto pl-[25px]">
        <ul className=" ul">
          ...
          <ul className={classNames.SubTopic + ` ul`}>
            ...
            <ul className={classNames.SubTopicRoman + ` ul`}>
              <li>

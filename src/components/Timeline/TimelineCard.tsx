  ...
  return (
    <div className="w-max flex flex-col justify-center items-center">
      ...
      <div className=" w-full h-full rounded-3xl border border-[#C7C7C7] bg-[#C7C7C7]/20">
        <div className="flex flex-col w-full h-full justify-center items-center gap-y-2 pt-9 pb-6 px-4">
          <p className="h-16 flex flex-col justify-center text-center font-ibm font-semibold text-secondary_blue-100">
            {title}
            <br />
            {title2}
          </p>

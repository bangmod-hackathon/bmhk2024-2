    ...
    <>
      <div className="flex h-screen w-full">
        <div className="m-auto flex w-full flex-col items-center justify-center">
          <div className="mb-9 text-center font-heading text-5xl text-white ">คุณสมบัติผู้สมัคร</div>
          <div className="mb-4 flex w-10/12 rounded-full  bg-gradient-to-b from-bg-400/25 to-secondary_blue-200/25 p-5 pr-12 ">
            ...
            <div className="m-auto w-full font-body text-white sm:text-xs md:text-lg lg:text-lg ">
          ...
          <div className="mb-4 flex w-10/12 rounded-full border bg-gradient-to-b from-bg-400/25 to-secondary_blue-200/25 p-5 pr-12 ">
            <div className="mr-7 flex aspect-square w-44 justify-center overflow-visible rounded-full bg-primary_yellow-200 text-center">

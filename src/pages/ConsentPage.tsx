    ...
    <React.Fragment>
      <div className="sm:bg-[url(/LoginPage/LoginPageBg.svg)] w-full h-screen bg-cover bg-[url(/LoginPage/LoginPageMobileBg.svg)]">
        ...
        <div className="flex flex-col h-full w-auto items-center justify-center">
          <div className=" bg-[#9ddef9]/10 sm:w-2/3 md:w-5/6 lg:w-1/2 w-4/5 flex flex-col items-center justify-center rounded-3xl p-8 gap-y-6 mt-28">
            <p className=" text-white font-heading md:text-4xl text-3xl">นโยบายข้อมูลส่วนบุคคล</p>
            <div className=" bg-white text-black w-full h-[480px] overflow-y-scroll">
              <LoremIpsum p={10} />
            </div>
